...
.PHONY: require-cloud-root require-run-id contract test validate-seed validate-generated validate-pilot dedupe-seed dedupe-pilot splits export-unsloth review review-pilot train-dry-run train infer-dry-run infer eval gates audit-cloud-run open-colab-brave retrain-bundle pilot-data
...
validate-generated: require-cloud-root
...
validate-pilot: require-cloud-root
